require([ 'angular', 'ceres-console/js/app-routes', 'ceres-console/theme/homer/scripts/directives/directives','app' ], function(angular) {
...
//	'ui.codemirror' // Ui Codemirror
	...
	require([ 'ceres-console/js/console-starter' ], function(starter) {
