(function(window, undefined) {
	var cui = (function() {
		var cui = {
			...
			__config : {
				defaultUri : {
					requirejs : '/api/classpath/query/support/starter/bower_components/requirejs/require.js',
			...
			ready : function(reqArgs, callFunc) {
				...
				if (this.__config.platform == undefined || this.__config.platform == "") {
					// 强制指定运行平台
				...
				this.loadScript(this.__config.defaultUri.requirejs, function() {
					...
					require([ configUrl ], function(sysConfig) {
						...
						configObj['http'].platform = cui.__config.platform;
