...
define([ 'app', 'icheck' ], function() {
	...
	/**
	 * panelToolsFullscreen - Directive for panel tools elements in right corner
	 * of panel with fullscreen option
	 */
		...
		return {
			...
			link : function(scope, elem, attrs) {
				...
				elem.on('blur', function() {
					 ...
					 * Date(elem.data("DateTimePicker").getDate().format()); //
					 * Global change propagation
					 * $rootScope.$broadcast("emit:dateTimePicker", { location:
					 * scope.location, action: 'changed', dateTime:
					 * scope.dateTime, example: scope.useCurrent });
					 * scope.$apply();
					 */
				})
			}
