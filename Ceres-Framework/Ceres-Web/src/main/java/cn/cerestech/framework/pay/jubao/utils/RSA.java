...
public class RSA {
	...
	public static void intialize(String cfgFile, String certDir) {
		try {
			SAXReader saxReader = new SAXReader();
			Document document = saxReader.read(new File(cfgFile));
			...
			BufferedReader privateKey = new BufferedReader(new InputStreamReader(new FileInputStream(certDir+"/"+pfx)));
			PRIVATE_KEY = "";
			String line = "";
			...
			PRIVATE_KEY = PRIVATE_KEY.replace("-----BEGIN RSA PRIVATE KEY-----", "").replace(
					"-----END RSA PRIVATE KEY-----", "");
			BufferedReader publicKey = new BufferedReader(new InputStreamReader(new FileInputStream(new File(certDir+"/"+cer))));
			PUBLIC_KEY = "";
